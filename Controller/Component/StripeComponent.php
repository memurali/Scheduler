 ...
 */
	public function charge($data, $customerId) {
 ...
 */
	public function updateCharge($chargeId, $data) {
		if (!$chargeId) {
 ...
 */
	public function updateCustomer($customerId, $fields) {
		if (!$customerId) {
			throw new CakeException(__('Customer Id is not provided'));
		}
 ...
 */
	public function updateCard($customerId, $cardId, $data) {
		if (!$customerId) {
			throw new CakeException(__('Customer Id is not provided'));
		}
 ...
 */
	public function listCards($customerId, $data = array()) {
		if (!$customerId) {
			throw new CakeException(__('Customer Id is not provided'));
		}
