                ...
                <table class="unstriped">
                  ...
                  <tbody>
                    <tr class="staff">
                      ...
                      <td class="working past"><a href="#">9A - 12P<span class="split">1A - 5P</span></a></td>
                      <td class="working past"><a href="#">9A - 5PM</a></td>
                      <td class="working past"><a href="#">9A - 5PM</a></td>
                      <td class="working past"><a href="#">9A - 5PM</a></td>
                      <td class="available current"><a href="#">9A - 5PM</a></td>
                      <td class="available"><a href="#">9A - 5PM</a></td>
                      <td class="working"><a href="#">9A - 5PM</a></td>
                    </tr>
                    <tr class="staff">
                    ...
                    <tr class="staff">
                      ...
                      <td class="available past"><a href="#">9A - 5PM</a></td>
                      <td class="available past"><a href="#">9A - 5PM</a></td>
                      <td class="working past"><a href="#">9A - 5PM</a></td>
                      <td class="working past"><a href="#">9A - 5PM</a></td>
                      <td class="working"><a href="#">9A - 5PM</a></td>
