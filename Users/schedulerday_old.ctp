                ...
                <table class="unstriped">
                  ...
                  <tbody>
                    <tr class="staff checked">
                      <td id="" class="name"><input type="radio" name="staff" value="Allen Abesamis" class="staffRow">Allen Abesamis<span id="" class="total-hours">0</span><img class="image-profile" src="https://bit.ly/2RGt5B9"></td>
                      <td class="availability">
                        <div class="grid-x">
                          <div class="cell large-auto available">
                            <span class="availability-time">
                              <span class="start">9A</span><span class="end">5P</span>
							</span>
							<input type='hidden' id='hideval1'value=''>
							<span class="scheduled" id="span1">9:00 A</span>
							
                          </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval2'value=''>
							<span class="scheduled" id="span2"><span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval3'value=''>
							<span class="scheduled" id="span3"></span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval4'value=''>
							<span class="scheduled" id="span4"></span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval5'value=''>
							<span class="scheduled" id="span5"></span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval6'value=''>
							<span class="scheduled" id="span6"></span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval7'value=''>
							<span class="scheduled" id="span7"></span>
						  </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval8'value=''>
							<span class="scheduled end-30" id="span8">4:30 P</span>
						  </div>
						                          
						  <input type='hidden' name='startval' id='startval' value='9:00 A'>
						  <input type='hidden' name='endval' id='endval' value='4:30 P'>
						  <input type='hidden' name='splitval' id='splitval' value=''>
						</div>
                      </td>
                    </tr>
                    <tr class="staff">
                      <td id="" class="name"><input type="radio" name="staff" value="Ayden Abesamis" class="staffRow">Ayden Abesamis<span id="" class="total-hours">0</span><img class="image-profile" src="https://bit.ly/2RGt5B9"></td>
                      <td class="availability not-available"></td>
                    </tr>
                    <tr class="staff">
                      <td id="" class="name"><input type="radio" name="staff" value="Jerome de Joya" class="staffRow">Jerome de Joya<span id="" class="total-hours">0</span><img class="image-profile" src="https://bit.ly/2RGt5B9"></td>
                      <td class="availability">
                        <div class="grid-x">
                          ...
                          <div class="cell large-auto available">
                            <span class="availability-time">
                              <span class="start">1P</span><span class="end">5P</span>
                            </span>
							<input type='hidden' id='hideval1'value=''>
                            <span class="scheduled" id="span1">1:00 P<span>
                          </div>
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval2'value=''>
							<span class="scheduled" id="span2"></span>
                          ...
                          <div class="cell large-auto available">
							<input type='hidden' id='hideval4'value=''>
							<span class="scheduled" id="span4">5.00 P</span>
						  </div>
						                    
						  <input type='hidden' name='startval' id='startval' value='1:00 P'>
						  <input type='hidden' name='endval' id='endval' value='5:00 P'>
                        </div>
                      </td>
                    </tr>
                    <tr class="staff">
                      <td id="" class="name"><input type="radio" name="staff" value="Michael Urata" class="staffRow">Michael Urata<span id="" class="total-hours">0</span><img class="image-profile" src="https://bit.ly/2RGt5B9"></td>
                      <td></td>
                    </tr>
                    <tr class="staff">
                      <td id="" class="name"><input type="radio" name="staff" value="Monica Abelardo" class="staffRow">Monica Abelardo<span id="" class="total-hours">0</span><img class="image-profile" src="https://bit.ly/2RGt5B9"></td>
                      <td></td>
                    </tr>
                  </tbody>
                </table>
