  ...
  <head>
    ...
    <div class="reveal tiny text-center" id="scheduleConfirmation" data-reveal>
      ...
      <div class="button-group expanded">
        <a class="button secondary" data-close>Save To Draft</a>
                ...
                <div class="grid-x">
                  <div class="small-6 cell">
                   ...
                   <div class="small-6 cell text-right">
                    <p><span class="published-date">February 3, 2018 </span><a href="#" class="button small" data-open="scheduleConfirmation">Save</a></p>
                  </div>
                </div>
              </div>
            </div>  
