...
//var now = new Date(date.getFullYear(), date.getMonth(), date("d")+2, 0, 0, 0);
...
var caldate = document.getElementById(el);
//alert('el');
	...
	cal_obj2.parse_date(caldate.value, format);

	cal_obj2.show_at_element(caldate, "adj_right-bottom");// adj_right-bottom
	cal_obj2.change_skin('alt');
	//popestimate();

}
function show_cal_estimate(el) 
{
...
function cal2_on_change(cal, object_code) 
{
	if (object_code == 'day') 
	{
		...
		//document.getElementById(cal_obj2.obj).value = cal.get_formatted_date(format);
		document.getElementById('calendardate').value = cal.get_formatted_date(format);
		if(cal_obj2.obj=='txtdate')
		{
		   document.getElementById('closedate').value = cal.get_formatted_date(format);
	    }
	    if(cal_obj2.obj=='closedate')
		{
		   document.getElementById('txtdate').value = cal.get_formatted_date(format);
	    }
	    if(cal_obj2.obj=='date')
		{
		   document.getElementById('pickdate').value = cal.get_formatted_date(format);
	    }
		cal.hide();
		cal_obj2 = null;
		calendar_change();
